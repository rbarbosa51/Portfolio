...
export default function Picture2() {
    ...
    const [demonChatText, setDemonChatText] = useState('Password or the dog gets it')
    ...
    return (
        ...
        <div className="h-screen">
          <Canvas>
            ...
            <Demon position={[-2,-1.3,1.5]} rotation={[0,0.436332,0]} demonState={demonAction} showDemonChat={showDemonChat} demonChatText={demonChatText}/>
          ...
          <div className="absolute top-2 left-1/2 -translate-x-1/2 text-center text-6xl text-green-600">
            <h1 className="neonText text-center text-6xl font-thin text-slate-200/80">{title}</h1>
          </div>
          <button
