...
const Terminal = () => (
    <div className="mockup-code">
      ...
      <pre data-prefix=">" className="text-success neonText"><code>Hire Rafael!</code></pre>
    </div>
)
const Skills = () => (
    <div className='px-6'>
...
const Share = () => (
    <div className='relative flex top-4 left-2 gap-8'>
        <div className='flex flex-col justify-center items-center' onClick={() => window.open(`https://www.facebook.com/sharer/sharer.php?u=${host}`, '_blank')}>
            <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 48 48" className='h-12 w-12'>
                <path fill="#039be5" d="M24 5A19 19 0 1 0 24 43A19 19 0 1 0 24 5Z"></path><path fill="#fff" d="M26.572,29.036h4.917l0.772-4.995h-5.69v-2.73c0-2.075,0.678-3.915,2.619-3.915h3.119v-4.359c-0.548-0.074-1.707-0.236-3.897-0.236c-4.573,0-7.254,2.415-7.254,7.917v3.323h-4.701v4.995h4.701v13.729C22.089,42.905,23.032,43,24,43c0.875,0,1.729-0.08,2.572-0.194V29.036z"></path>
            </svg>
            <div>Facebook</div>
        </div>
        <div className='flex flex-col justify-center items-center' onClick={() => window.open(`https://twitter.com/intent/tweet?url=${host}`, '_blank')}>
            <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 48 48" className='h-12 w-12' >
                <path fill="#212121" fill-rule="evenodd" d="M38,42H10c-2.209,0-4-1.791-4-4V10c0-2.209,1.791-4,4-4h28	c2.209,0,4,1.791,4,4v28C42,40.209,40.209,42,38,42z" clip-rule="evenodd"></path><path fill="#fff" d="M34.257,34h-6.437L13.829,14h6.437L34.257,34z M28.587,32.304h2.563L19.499,15.696h-2.563 L28.587,32.304z"></path><polygon fill="#fff" points="15.866,34 23.069,25.656 22.127,24.407 13.823,34"></polygon><polygon fill="#fff" points="24.45,21.721 25.355,23.01 33.136,14 31.136,14"></polygon>
            </svg>
            <div>Twitter/X</div>
        </div>
        <div className='flex flex-col justify-center items-center' onClick={() => window.open(`https://www.addtoany.com/add_to/whatsapp?linkurl=${host}`, '_blank')}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" className='h-12 w-12'>
        ...
        <div className='flex flex-col justify-center items-center' onClick={() => window.open(`mailto:?&subject=Developer%20Profile&cc=&bcc=&body=${host}`, '_blank')}>
            <svg className='h-12 w-12 fill-slate-500/80' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
    ...
    return (
        <div className='relative h-screen bg-gradient-to-b from-blue-100 to-blue-400'>
            ...
            <div className='flex flex-col items-center justify-center text-xs md:text-sm absolute top-[55%] left-[3%] text-blue-600' onClick={() => window.open('https://drive.google.com/file/d/1TpmA0hnA6PjHiS66V1CX972sd64GfHQq/view?usp=sharing', '_blank')}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40" className='h-12 w-12'>
            ...
            {/* ShareFolder */}
            <div className='flex flex-col items-center justify-center text-xs md:text-sm absolute top-[20%] right-[40.5%] text-blue-600' onClick={() => openWinBox('Share', 500, 350, null, <Share />)}>
                ...
                <div className='underline mt-2 ml-1 bg-gradient-to-r bg-clip-text from-blue-700 to-red-500 text-transparent' >Share</div>
            </div>
            {/* Windows */}
            {windows}
        </div>
