...
export default function Desktop() {
  ...
  return (
    <div className="relative h-screen bg-gradient-to-b from-blue-100 to-blue-400">
      ...
      {/* Wikipedia */}
      <div
        className="absolute left-[25%] top-[20%] flex flex-col items-center justify-center text-xs text-blue-600 md:text-sm lg:left-[35%]"
        onClick={() =>
      ...
      {/* GitHub */}
      <div
        className="absolute left-[30%] top-[35%] flex flex-col items-center justify-center text-xs text-blue-600 md:text-sm lg:left-[20.5%]"
      ...
      {/* Linked In */}
      <div
        className="absolute left-[25%] top-[55%] flex flex-col items-center justify-center text-xs text-blue-600 md:text-sm lg:left-[19.5%]"
        onClick={() =>
      ...
      {/* Terminal */}
      <div
        className="absolute bottom-[20%] right-[30%] flex flex-col items-center justify-center text-xs text-blue-600 md:text-sm lg:right-[23.5%]"
