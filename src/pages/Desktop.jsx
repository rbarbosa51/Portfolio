    ...
    return (
        <div className='relative h-screen bg-gradient-to-b from-blue-100 to-blue-400'>
            <div className='w-full h-full flex justify-center items-center'>
                <h1 className='text-5xl md:text-7xl bg-gradient-to-r bg-clip-text from-blue-700 to-red-400 text-transparent font-thin'>Rafael's Desktop</h1>
            ...
            <div className='absolute bg-slate-200/50 top-0 border-1 border-black/10 w-full h-8 flex justify-between items-center p-8'>
                <div className='flex gap-2'>
                    <Dropdown className='bg-slate-200/50'>
                        <DropdownTrigger><Button variant='' className='text-md md:text-xl hover:bg-slate-100  bg-gradient-to-r bg-clip-text from-blue-700 to-red-400 text-transparent'>File</Button></DropdownTrigger>
                        <DropdownMenu className=''>
                            <DropdownItem key='thanks' onClick={() => openWinBox('Thanks', 500, 350, null, <Thanks/>)} className='bg-gradient-to-r bg-clip-text from-blue-700 to-red-400 text-transparent'>Thanks</DropdownItem>
                            <DropdownItem key='exit' onClick={() => navigate('/')} className='bg-gradient-to-r bg-clip-text from-blue-700 to-red-400 text-transparent'>Exit</DropdownItem>
                        </DropdownMenu>
                    </Dropdown>
                    <Dropdown className='bg-slate-200/50'>
                        <DropdownTrigger><Button variant='' className='text-md md:text-xl hover:bg-slate-100 bg-gradient-to-r bg-clip-text from-blue-700 to-red-400 text-transparent'>Info</Button></DropdownTrigger>
                        <DropdownMenu>
                            <DropdownItem key='about' onClick={() => {}} className='bg-gradient-to-r bg-clip-text from-blue-700 to-red-400 text-transparent'>Placeholder 1</DropdownItem>
                            <DropdownItem key='exit' onClick={() => {}} className='bg-gradient-to-r bg-clip-text from-blue-700 to-red-400 text-transparent'>Placeholder 2</DropdownItem>
                        </DropdownMenu>
                    </Dropdown>
                </div>
                <div className='text-md md:text-xl hover:bg-slate-100 bg-gradient-to-r bg-clip-text from-blue-700 to-red-400 text-transparent'>
            ...
            <div className='flex flex-col items-center justify-center text-xs md:text-sm absolute top-[20%] left-[15%] text-blue-600' onClick={() => openWinBox('Wikipedia',500,300, 'https://www.wikipedia.com', null)}>
                ...
                <div className='underline bg-gradient-to-r bg-clip-text from-blue-700 to-red-400 text-transparent' >Wikipedia</div>
            </div>
            {/* Resume */}
            <div className='flex flex-col items-center justify-center text-xs md:text-sm absolute top-[55%] left-[3%] text-blue-600' onClick={() => window.open('https://drive.google.com/file/d/1TpmA0hnA6PjHiS66V1CX972sd64GfHQq/view?usp=sharing', '_blank')}>
                ...
                <div className='underline bg-gradient-to-r bg-clip-text from-blue-700 to-red-400 text-transparent' >Resume</div>
            </div>
            {/* Email */}
            <div className='flex flex-col items-center justify-center text-xs md:text-sm absolute top-[35%] left-[3.5%] text-blue-600' onClick={() => window.open('mailto:rafael.barbosa51@gmail.com', '_blank')}>
                ...
                <div className='underline bg-gradient-to-r bg-clip-text from-blue-700 to-red-400 text-transparent' >Email</div>
            </div>
            {/* Windows */}
            {windows}
        </div>
