...
export default function First() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-400 to-pink-400">
      <h1 className="neonText py-4 text-center text-6xl font-thin text-slate-200/80">
        Welcome to my Room
      </h1>
      <div className="neonText mt-2 text-center text-2xl font-thin text-slate-200/80">
