    ...
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        <group name="Armature">
          ...
          <skinnedMesh name="Rafael" geometry={nodes.Rafael.geometry} material={materials.All} skeleton={nodes.Rafael.skeleton} />
          <Html as='div' wrapperClass="w-96 bg-transparent" position={[0.3,2.3,0]}>
            
            <div className="chat chat-start">
              <div className="chat-bubble  bg-blue-400 text-white">
                {chatText[textPosition]}
                <div className='flex justify-end'>
                  <button className="mt-2 btn btn-outline btn-xs text-white" onClick={() => setTextPosition(prev => ((prev + 1) % chatText.length))}>Next</button>
                </div>
              </div>
            </div>
