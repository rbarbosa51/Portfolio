  ...
  return (
    <div className="flex flex-col items-center justify-center">
      <div className="carousel max-w-[80%]">
        ...
        <div id="item3" className="carousel-item w-full">
          <Card
            ...
            sourceCode={
              "https://github.com/rbarbosa51/machine-learning-finger-trails"
            }
          ></Card>
        </div>
        <div id="item4" className="carousel-item w-full">
          <Card
            picture={"/projects/toxicity.png"}
            ...
            url={
              "https://rbarbosa51.github.io/TensorFlow.JS_Toxicity_Detector/"
            }
            stack={"Machine_Learning"}
            sourceCode={
              "https://github.com/rbarbosa51/TensorFlow.JS_Toxicity_Detector"
            }
          ></Card>
        </div>
        ...
        <div id="item5" className="carousel-item w-full">
          <Card
            picture={"/projects/whatacrypto.png"}
        ...
        <div id="item7" className="carousel-item w-full">
          <Card
            picture={"/projects/particles.png"}
      ...
      <div className="flex w-full justify-center gap-2 py-2">
        ...
        <a href="#item5" className="btn btn-sm">
          5
        </a>
        <a href="#item6" className="btn btn-sm">
          6
        </a>
        <a href="#item7" className="btn btn-sm">
          7
        </a>
      </div>
    </div>
